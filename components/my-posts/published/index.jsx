...
const MyPublishedPosts = ({ pagination_url }) => {
  ...
  useEffect(() => {
    const url = `/api/post/all-posts?paginate=${paginate}&page_number=${page_number}&published=1`;
    axios
  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      <>
        <title>پست های منتشر شده</title>
      </>
      <div className="flex items-center justify-between gap-2 ">
        <div className="text-xl">پست های منتشر شده</div>
      </div>
