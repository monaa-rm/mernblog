...
const UserNotifications = ({ goalId, pagination_url }) => {
  ...
  useEffect(() => {
    const url = `/api/dashboard/user/user-notifs/${goalId}?paginate=${paginate}&page_number=${page_number}`;
    axios
  ...
  return (
    <div className=" flex flex-col gap-12 ">
      <>
        <title>نوتیفیکیشن های کاربر</title>
      </>
      <div className="text-xl">نوتیفیکیشن های کاربر</div>
      <div className=" flex flex-col gap-12 ">
        {all_notifs == -1 ? (
          <Loading />
        ) : all_notifs == -2 ? (
