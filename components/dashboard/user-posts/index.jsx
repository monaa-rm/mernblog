...
const UserPostsMain = ({ pagination_url, goalId }) => {
  ...
  useEffect(() => {
    const url = `/api/dashboard/user/user-posts/${goalId}?paginate=${paginate}&page_number=${page_number}`;
    axios
  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      <>
        <title>همه پست های کاربر</title>
      </>
      <div className="flex items-center justify-between gap-2 ">
        <div className="text-xl pt-12 md:pt-0">همه پست های کاربر</div>
      </div>
