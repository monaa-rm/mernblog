...
const AdsMain = ({ pagination_url }) => {
  ...
  useEffect(() => {
    const url = `/api/dashboard/ads/all?paginate=${paginate}&page_number=${page_number}`;
    axios
  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      <div className="flex items-center flex-wrap justify-between gap-2 pt-12 sm:pr-12 md:pr-0 sm:pt-0">
        <div className="text-xl ">همه تبلیغ ها</div>
        <Link
          className="px-1 md:px-3 py-2 z-10 fixed   top-[8.7rem] md:top-[8.3rem] text-white rounded-md  left-6 sm:left-12 md:left-24 lg:left-12 bg-blue-500 hover:bg-blue-600 transition-all duration-500 "
                ...
                >
                    ...
                    <div className="flex items-center flex-wrap justify-center md:justify-end gap-1 md:gap-4">
                      <button
                        onClick={() => {
                          ...
                          setRemoveUrl(
                            `/api/dashboard/ads/remove-ads/${item._id}`
                          );
                        }}
                  ...
                  <div className="flex flex-wrap justify-center md:justify-between items-center gap-1 md:gap-4">
                    ...
                    {item.post_id == "no-post" ? null : (
                      <div className="px-1 md:px-3 py-2  flex justify-center items-center rounded-lg bg-blue-500 transition-all duration-500 text-white hover:bg-blue-600 ">
                        <Link
