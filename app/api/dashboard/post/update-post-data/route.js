...
export async function POST(req) {
  try {
    ...
    if (inputData.manager_accept == true && inputData.published == false) {
      return NextResponse.json(
        { data: "آیتم انتشار مقاله اشتباه است" },
        { status: 402 }
      );
    ...
    const PostFullData = {
      ...
      time: theTime,
      view_num: inputData.view_num,
      likes_num: inputData.likes_num,
      manager_accept: inputData.manager_accept,
    };
