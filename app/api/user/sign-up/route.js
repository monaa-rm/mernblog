...
export async function POST(req) {
   ...
   try {
      ...
      if (!/^[\w\d\s-]+$/.test(inputData.username)) {
         return NextResponse.json({ data: "برای بخش نام کاربری، فقط اعداد، عبارات انگلیسی و -_/  وارد کنید... ", }, { status: 402 });
      }
      ...
      if (inputData.phone.length != 10) {
         return NextResponse.json({ data: "شماره همراه باید 10 کارکتر باشد بدون 98+ یا صفر ابتدایی... ", }, { status: 402 });
      }
